...
{
    public class Ads2221Controller : Controller
    {
        private readonly ApplicationDbContext _context;

        public Ads2221Controller(ApplicationDbContext context)
        {
            _context = context;
        }
